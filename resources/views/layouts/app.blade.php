    ...
    <div class="container-fluid">
        <footer class="row">
            <div class="footer" style="text-align: center !important; font-size:14px !important; ">
                <p>Made With <span style="font-size:14px !important; color:#BD1831;" class="fa fa-heart"></span> By <a href="https://edrisa.com" target="_blank">Edrisa</a> <span style="font-size: 12px;">version 1.1</span></p>
            </div>
        </footer>
    </div>
